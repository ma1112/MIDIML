...
def getNs(fs = 22050, H = 0.5, fArray = np.linspace(100,1300,13), verbose = 0):
	resultDict = {}
...
x = running_mean(x,10).astype('int16')
#wavwrite('noisedfiltered2.wav',22050, x)
x =  x+ np.random.normal(0,0,len(x)).astype('int16')
wavwrite('noisedfiltered.wav',22050, x)
print('asd')